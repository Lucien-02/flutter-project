...
class AppColors {
  ...
  static const Color backgroundScreen = Color(0xFF15232E);
  ...
  static const Color bottomBarSelected = Color(0xFF12273C);
  static const Color bottomBarTextSelected = Color(0xFF3792FF);
